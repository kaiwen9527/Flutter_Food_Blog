...
class ArtCoffeePage extends StatelessWidget {
  const ArtCoffeePage({super.key});
  ...
  Widget build(BuildContext context) {
    List<Image> images = [
      ...
      Image.asset(
        'images/singleFood/artCoffeeDeli/environment1.jpg',
        // fit: BoxFit.cover,
      ),
      Image.asset('images/singleFood/artCoffeeDeli/environment2.jpg'),
    ];
              ...
              children: <Widget>[
                Row(
                  ...
                  children: <Widget>[
                    ...
                    Text(
                      // foodLocations[1].name,
                      S.of(context).artCoffee,
