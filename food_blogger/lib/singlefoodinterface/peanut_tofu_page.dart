...
class PeanutTofuPage extends StatelessWidget {
  const PeanutTofuPage({super.key});

  @override
  Widget build(BuildContext context) {
    List<Image> images = [
      Image.asset('images/singleFood/laiPeanutTofu/peanutTofu.jpg'),
      Image.asset('images/singleFood/laiPeanutTofu/douhua.jpg'),
    ];
            ...
            child: Column(
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Text(
                    S.of(context).peanutTofuContent,
                ...
                ListTile(
                  ...
                  title: Text(
                    S.of(context).peanutTofuAddress,
                    style: TextStyle(
                        color: Theme.of(context).primaryColor, fontSize: 13.sp),
                  ),
                ),
